// Dialog_605_EN.js	2019/7/19 by T. Fujita
...
'</center></form></p></div>');
	...
	$('#dialog_002').dialog({
        ...
        $("body").append('<div id="dialog_AD_003" style="z-index: 2000;"><p><form name="Form_AD_003">'+
'Title: <input type="text" style="width: 230px;" name="txt_file" value=""></form></p><HR>'+
'<p> Please select the Photo File.'+
'<form name="photoinput">'+
'<center><TD><input type="file" accept="image/*" name="select_AD" id="select_AD_003" value="" onchange="updateImageDisplay()"></TD>'+
'  <BR>'+
'<div class="preview"><p>Photo File is not selected.</p></div></center></form></p></div>');

	$('#dialog_AD_003').dialog({
		autoOpen: false,
...
function Dialog_Additional_003() {
	var preview = document.querySelector('.preview');
	document.Form_AD_003.txt_file.value = "";
	document.photoinput.select_AD.value = "";
	while(preview.firstChild){
		preview.removeChild(preview.firstChild);
	}
	$('#dialog_AD_003').dialog('open');
}
...
function Photo_Data() {
	...
	var photoIcon_01 = L.divIcon({className: 'imageCover1', html: "<img src='" + image.src + "' alt='Photo' class='baseImage'> <img src='./ICONS/Photo_Frame_214.png' alt='Icon' class='coverImage'>"});
	var photoIcon_02 = L.divIcon({className: 'imageCover2', html: "<img src='" + image.src + "' alt='Photo' class='baseImage'> <img src='./ICONS/Photo_Frame_215.png' alt='Icon' class='coverImage'>"});
